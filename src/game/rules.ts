...
export const GAME_RULES = [
  ...
  'speed (tiles moved per second), range, hp, and power (damage dealt per hit). Current unit',
  'positions, stats, owners, and orders are listed in the game state below.',
  '',
  ...
  '  attacking until the target is destroyed or you reorder it. Bases are the attackable targets.',
